...
GOOGLE_REFRESH_TOKEN_1 = _env("GOOGLE_REFRESH_TOKEN_1", _env("GOOGLE_REFRESH_TOKEN"))
GOOGLE_REFRESH_TOKEN_2 = _env("GOOGLE_REFRESH_TOKEN_2")
GOOGLE_REFRESH_TOKEN_3 = _env("GOOGLE_REFRESH_TOKEN_3")
GOOGLE_REFRESH_TOKEN_4 = _env("GOOGLE_REFRESH_TOKEN_4")
...
# Backward-compatible alias for code that still expects a single bootstrap token.
